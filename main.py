...
def process_image_and_draw_contours(image_bytes):
    try:
        # Add your existing image processing code here, handling bytes:
        ...
        # Create a dictionary to store refined contour coordinates
        contour_coordinates = {}
        for idx, contour in enumerate(contours):
            ...
            # Store the refined coordinates
            contour_coordinates[idx] = [(int(point[0][0]), int(point[0][1])) for point in approx]
